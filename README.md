...
Put the following lines inside the `<head></head>` of you HTML file. These very basic CSS styles. You can customize them to match the theme of your website. See [Generated HTML structure](#generated-html-structure) to know the HTML Structure of the pin and list elements generated by this script.
```
<style>
svg {
